...
file_path = f'/Users/baptiste/Desktop/osm2qgis/csv/before/CSV/{nom_fichier}.csv'
# Continuer le reste du script en utilisant chemin_fichier_csv

# Chemin vers le nouveau fichier CSV
new_file_path = f'/Users/baptiste/Desktop/osm2qgis/csv/during/{nom_fichier}_step1.csv'
